...
##### read in object 
obj <- readRDS(file = file.path(seurat_objects_dir,"Neo_P14_eos_blood_bone_marrow_spleen.rds"))
...
##### save objects 
saveRDS(obj, file.path(seurat_objects_dir,"Neo_P14_eos_blood_bone_marrow_spleen_annotated.rds"))

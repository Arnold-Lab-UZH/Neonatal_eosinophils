...
ggsave(file.path(integration_eos_plots_dir,"umap_annotated_CD45pos.svg"), width = 8, height = 5, plot = p)
...
#Eos: #E22B17
#B:mature IghM: #EDB20C; Plasma cells IgA: #DDED0C
...
##### proportion plot 
create_table_cell_type_prop(immune, "condition","annotation",file.path(integration_eos_tables_dir),"/CD45pos")
df <- read.csv(file.path(integration_eos_tables_dir,"CD45pos_proportions_condition_annotation.csv"), header = TRUE)
...
ggsave(file.path(integration_eos_plots_dir,"cell_type_prop.svg"), width = 12, height = 6, plot = p)

##### statistics 
#neo wt vs adult wt 
cell_type_prop_stats(immune,"annotation","adult_wt","neo_P14_wt","condition",1.2,
                     file.path(integration_eos_plots_dir,"neo_wt_vs_adult_wt_CD45pos_stat.pdf"))

#neo wt vs neo phil 
cell_type_prop_stats(immune,"annotation","neo_P14_phil","neo_P14_wt","condition",1.2,
                     file.path(integration_eos_plots_dir,"neo_wt_vs_neo_phil_CD45pos_stat.pdf") )

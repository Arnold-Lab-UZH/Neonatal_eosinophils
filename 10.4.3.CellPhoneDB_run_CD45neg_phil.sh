...
export OUTPUT_DIR="${TABLES_DIR}/neo_CD45neg_phil_output"
export COUNTS_FILE="${TABLES_DIR}/CD45_neo_phil_count.txt"
export META_FILE="${TABLES_DIR}/CD45_neo_phil_meta.txt"
